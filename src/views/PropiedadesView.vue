<template>
  <MainLayout>
    <div class="contenido-container">
      <div class="contador-edit-container">
        <div class="edit-container">
          <ToggleIconButton
            ...
            initialImage="basura_icono.svg"
            otherImage="from_red_delete_icono.svg"
            v-model="isDefault"
          />
        </div>
          ...
          >
            <RouterLink :to="'/propiedades/' + propiedad.id">
              <ProfileButton
                widthProp="200px"
                heightProp="200px"
                image="propiedad-icono.svg"
                :class="{ disable: !isDefault }"
              />
            </RouterLink>
            <div
              class="delete-propiedad"
              v-if="!isDefault"
              @click="clickDeleteButton(propiedad.id)"
            >
              <ProfileButton
                widthProp="45px"
                heightProp="45px"
                image="basura_icono.svg"
      ...
      <ConfirmPopup
        :visible="openPopup"
        title="¿Estás seguro de que quieres eliminar esta propiedad?"
...
const canAddProperty = computed(() => propiedades.value.length < 10)
