      ...
      <div class="info-container">
        <div class="info-propiedad-container">
          ...
          <div class="info-propiedad-detalles">
            ...
            <li>
              Dimensiones: {{ propiedad.largo }} x {{ propiedad.ancho }} x
              {{ propiedad.alto }} {{ propiedad.medida }}
            </li>
          </div>
        </div>
...
const urlImgPropiedad = ref(
  'https://upload.wikimedia.org/wikipedia/commons/c/ca/Machu_Picchu%2C_Peru_%282018%29.jpg',
)
const urlImgMapa = ref(
  'https://www.cervantesvirtual.com/images/portales/constituciones_hispanoamericanas/graf/mapas/06-mexico_mapa_de_los_estados_s.jpg',
)
</script>
